...
const Chara = (() => {
  ...
  const LINES = {
    ...
    play: [
      { who: "me", expr: "happy", lines: ["気分転換も仕事のうち！リフレッシュ完了！", "よく遊び、よく働く。やる気が湧いてきた！"] },
    ],
    talk: [
      { who: "me", expr: "happy", lines: ["同僚と本音トーク。なんだか心が軽くなった。", "チームの空気があったかい。ここで頑張りたいな。"] },
    ],
    stress_high: [
      { who: "me", expr: "tired", lines: ["最近、夜あまり眠れない…そろそろ限界かも…", "胸の奥が重い…遊んだり話したりして発散しないと…"] },
      { who: "oyakata", expr: "worried", lines: ["顔色が悪いぞ。ストレスは溜めるな、吐き出せ。"] },
    ],
    study: [
    ...
    hint: [
      { who: "oyakata", expr: "normal", lines: [
        "得意（★）の能力は安く上げられる。ビルドの軸にしろ。",
        "ストレスはメンタルが高いと溜まりにくい。100になると倒れるぞ。",
        "やる気が高いほど経験点が増える。「遊ぶ」は無駄じゃない。",
        "わしの評価と同僚の評価、両方取るのは難しい。どう生きるかだ。",
        "同僚評価が高いと助けてもらえる。低いと…孤独だぞ。",
        "判断力が高いと、イベントの「うまい落としどころ」が決まりやすい。",
        "客評価は営業の結果で動く。エンディングにも関わるぞ。",
      ] },
    ],
    finish_great: [
